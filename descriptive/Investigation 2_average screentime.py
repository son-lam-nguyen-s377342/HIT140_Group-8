...
# Load the datasets
dataset1 = pd.read_csv('C:\\Users\\Asus\\Desktop\\SEMESTER 2\\DATA SCIENCE\\dataset1.csv')
dataset2 = pd.read_csv('C:\\Users\\Asus\\Desktop\\SEMESTER 2\\DATA SCIENCE\\dataset2.csv')
...
plt.tight_layout()
# plt.savefig("./plots/mean_screen_time_by_gender.png", dpi=300)
plt.show()
